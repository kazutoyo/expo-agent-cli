...
const fetchLatestSdkVersion = async (): Promise<string> => {
  ...
  const appJsonUrl = 'https://raw.githubusercontent.com/expo/expo/refs/heads/main/apps/expo-go/app.json';
...
export async function getExpoDocsInfo(path: string): Promise<ExpoDocsInfo> {
  ...
  const baseUrl = 'https://raw.githubusercontent.com/expo/expo/refs/heads/main/docs/pages';
